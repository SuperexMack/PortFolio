...
function MainBg(){
    return(
        ...
        <div className="h-96 w-96 contentfirst  relative top-24 flex flex-col p-20">
          ...
          <div className="h-96 w-96 contentsecond flex flex-row relative top-16 p-9 text-center">
            <div className="firstContent mt-10 text-2xl relative left-10 space-y-8">

            <div className="bg-orange-600 titleBox cursor-pointer">Landing Pages</div>
            <div className="bg-orange-600 titleBox cursor-pointer">Full Stack Application</div>
            <div className="bg-orange-600 titleBox cursor-pointer"> Portfolio websites</div>
            <div className="bg-orange-600 titleBox cursor-pointer">React Applications</div>
